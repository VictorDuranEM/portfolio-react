  ...
  return (
    <footer className="bg-[#111] text-accent text-center py-12 px-0 mt-auto">
      ...
      <ul className="flex justify-center items-center mt-8 gap-8">
        ...
        <li><a className="text-h3 hover:opacity-70 inline-block" href="https://www.frontendmentor.io/profile/VictorDuranEM" target='_blank'><img className='w-[1.7rem]' src={frontendMentorLogo}/></a></li>
